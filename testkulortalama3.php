                   ...
                   $questionid = $cek['id'];
                    ...
                    echo ' <table style="width:100%" border="1"> ';
                        ...
                        while ($cek2 = $sor2 ->fetch(PDO::FETCH_ASSOC))
                      {
                        ...
                        $sql2 = "SELECT * from result WHERE res3 LIKE '". $res3 ."' and res1 LIKE '". $res1 ."' and res5 LIKE '". $res5 ."' and res6 LIKE '". $res6 ."' ";
                      ...
                      if($kontrol2 == 1)
                        {  
                      echo '<tr><th style="width:80%">'. $cek2['ans3'] .' </th>    </tr>' ;   
                      // echo'<br>';
