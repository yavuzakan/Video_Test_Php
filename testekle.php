...
<h3 class="bg-gray p-4">Test Name</h3>
                    <form action="testekle2.php" method="post">
                
                            <input type="text" name="testname1" placeholder="Test Name" class="border p-3 w-100 my-2">
