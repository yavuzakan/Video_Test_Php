         ...
         if($_SESSION['valid_durum'] == 'admin')
               ...
               ';
                     ...
                     while ($cek = $sor ->fetch(PDO::FETCH_ASSOC))
                {
                     ...
                     echo'   
                         <form id="form1" name="form1" style="width:100%" action="dersduzenle.php" method="POST" > 
                   <input type="hidden" id="delete" name="delete" value="0">
               <input type="hidden" id="id" name="id" value="'. $cek['id'] .'">
               
               
                 <tr>
                   <th>  <input type="text" name="ders1"  class="border p-3 w-100 my-2" value="'. $cek['ders1'] .'"> </a></th>
                   <th>  <input type="text" name="ders2"  class="border p-3 w-100 my-2" value="'. $cek['ders2'] .'"> </a></th>
                   <th>  <input type="text" name="file6"  class="border p-3 w-100 my-2" value="'. $cek['ders3'] .'" disabled> </a></th>
