...
<input type="hidden" id="button" name="button" value="Atama">
 ...
 <?PHP  
       ...
       while ($cek = $sor ->fetch(PDO::FETCH_ASSOC))
       {
          ...
          echo'   
              <form  class="a1" >
          <input type="hidden" id="dersid" name="dersid" value="'. $id.'">
    ...
    $bilgilerimsor = $db->prepare("SELECT * from user where user1 LIKE '%".$ara."%'");
	 ...
	 $sayi = $bilgilerimsor->rowCount();   
				  ...
				  //linkleri ekle
					...
					<li class='page-item'><a class='page-link' href=".$_GET['link2']."?page=0&ara=".$ara ."&id=".$id ."   >1</a></li>"; 
					while($sayi > 6) 
						{
						...
						echo "<li class='page-item'><a class='page-link'  href=".$_GET['link2']."?page=".$sayi3 ."&ara=".$ara ."&id=".$id ." >". $sayi2 ."</a></li>";  
